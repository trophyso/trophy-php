...
use Trophy\Users\Types\UsersPointsEventSummaryRequestAggregation;

class UsersPointsEventSummaryRequest extends JsonSerializableType
{
    /**
     * @var value-of<UsersPointsEventSummaryRequestAggregation> $aggregation The time period over which to aggregate the event data.
     */
    ...
    /**
     * @param array{
     *   aggregation: value-of<UsersPointsEventSummaryRequestAggregation>,
     *   startDate: string,
     *   endDate: string,
     * } $values
     */
