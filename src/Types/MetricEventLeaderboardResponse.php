...
class MetricEventLeaderboardResponse extends JsonSerializableType
{
    /**
     * @var ?string $end The end date of the current run of the leaderboard, or null if the run never ends.
     */
    #[JsonProperty('end')]
    public ?string $end;

    /**
     * @var ?int $rank The user's rank in the leaderboard, or null if the user is not on the leaderboard.
     */
    #[JsonProperty('rank')]
    public ?int $rank;

    /**
     * @var ?int $previousRank The user's rank in the leaderboard before the event, or null if the user was not on the leaderboard before the event.
     */
    #[JsonProperty('previousRank')]
    public ?int $previousRank;

    /**
     * @var float $threshold The minimum value required to enter the leaderboard according to its current rankings.
     */
